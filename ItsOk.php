...
<head>
    ...
    <title>Its Ok - YouTube Views Hack</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="jumbotron">
            ...
            <p>
                <a class="btn btn-lg btn-primary" href="https://github.com/singhsidhukuldeep/" role="button">Find me on Github »</a>
                <a class="btn btn-primary" href="https://github.com/singhsidhukuldeep/" id="stars"></a>
            </p>
        </div>
        ...
        <div class="row tall-row">
            <div class="col-lg-12">
                <h1>If you change your mind :<b>Disclaimer</b></h1>
                <hr>
            </div>
        </div>
        <div class="row">
